			...
			html += '">'
				+'<div class="drp_top-bar">\
					<div class="normal-top">\
						<span style="color:#333">来期:</span> <b class="start-day">...</b>'
			if ( ! opt.singleDate ) {
				html += '<span class="separator-day">离期:</span> <b class="end-day"></b> <i class="selected-days">(<span class="selected-days-num">3</span> '+lang('days')+')</i>'
			}
			html += '</div>\
