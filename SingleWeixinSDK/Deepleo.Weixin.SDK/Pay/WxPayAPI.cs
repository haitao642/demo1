...
namespace Deepleo.Weixin.SDK.Pay
{
    ...
    public class WxPayAPI
    {
        ...
        public static string Sign(IDictionary<string, string> stringADict, string partnerKey)
        {
           ...
           // Public.LogHelper.LogInfo(stringSignTemp);
        ...
        /// <returns></returns>
        public static string PaySign(string appid, string timestamp, string noncestr, string prepay_id, string signType, string partnerKey)
        {
            var stringADict = new Dictionary<string, string>();
            stringADict.Add("appId", appid);
            stringADict.Add("timeStamp", timestamp);
            stringADict.Add("nonceStr", noncestr);
            stringADict.Add("package", string.Format("prepay_id={0}", prepay_id));
