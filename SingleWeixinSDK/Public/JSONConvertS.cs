...
namespace Public
{
    public static class JSONConvertS
    {
        ...
        private static JSONObjectS _json = new JSONObjectS();//寄存器
        ...
        private static JSONObjectS DeserializeSingletonObject(string text)
        {
        ...
        public static JSONObjectS DeserializeObject(string text)
        {

            return _json[Deserialize(text)] as JSONObjectS;
        ...
        public static string SerializeObject(JSONObjectS jsonObject)
        {
            ...
            foreach (KeyValuePair<string, object> kvp in jsonObject)
            {
                ...
                if (kvp.Value is JSONObjectS)
                {

                    sb.Append(string.Format("\"{0}\":{1},", kvp.Key, SerializeObject((JSONObjectS)kvp.Value)));
        ...
        public static string SerializeArray(JSONArray jsonArray)
        {
            ...
            for (int i = 0; i < jsonArray.Count; i++)
            {
                ...
                if (jsonArray[i] is JSONObjectS)
                {

                    sb.Append(string.Format("{0},", SerializeObject((JSONObjectS)jsonArray[i])));
    ...
    public class JSONObjectS : Dictionary<string, object>
